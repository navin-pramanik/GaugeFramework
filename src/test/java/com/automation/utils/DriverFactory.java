...
public class DriverFactory {
     ...
     */
    public void captureNetworkLogs(String filePath) {
        List<LogEntry> entries = driver.manage().logs().get(LogType.PERFORMANCE).getAll();
        System.out.println(entries.size() + " " + LogType.PERFORMANCE + " log entries found");
        BufferedWriter writer = null;
        try{
            //String fileName = "NetworkLogs"
        ...
        for (LogEntry entry : entries) {
            ...
            if (method != null && "Network.responseReceived".equals(method)) {
                ...
                if(type.equalsIgnoreCase("xhr")){
                    ...
                    writer.write("Response returned for :" + messageUrl + " is : " + status);
                    writer.write(new Date(entry.getTimestamp()) + " " + entry.getLevel() + " " + message.toString());
                    writer.write("\n");
                }
            }
