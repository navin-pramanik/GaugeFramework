...
public class SeleniumActions {
    ...
    private static WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(15));//new WebDriverWait(driver , 15);
    ...
    protected void takeScreenshotOfWebElement(WebElement element){
        File source = element.getScreenshotAs(OutputType.FILE);
        File destination = new File(System.getProperty("user.dir") +
                "/reports/screenshots/snap"+System.currentTimeMillis()+".png");
